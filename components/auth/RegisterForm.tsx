  ...
  if (success) {
    return (
      <div className="w-full max-w-md p-4 sm:p-8">
        <div className="bg-[var(--background-secondary)] rounded-2xl border border-[var(--border)] p-6 sm:p-8 text-center">
      ...
      <div className="bg-[var(--background-secondary)] rounded-2xl border border-[var(--border)] p-6 sm:p-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-semibold text-[var(--text-primary)]">
            Criar conta no Gridiz
          </h1>
          <p className="text-sm text-[var(--text-secondary)] mt-1">
            Compartilhe seu setup e ganhe com seus links de afiliado
          </p>
        </div>
